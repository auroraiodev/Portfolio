    ...
    >
      ...
      >
        ...
        >
          ...
          <motion.h1
            variants={itemVariants}
            className="noto-serif hero-title"
            style={{
          ...
          <motion.p
            variants={itemVariants}
            className="manrope hero-subtitle"
            style={{
            ...
            >
              ...
              <div
                style={{
                  ...
                  width: "192px",
                  height: "192px",
                  borderRight: "1px solid rgba(233, 193, 118, 0.4)",
                  borderBottom: "1px solid rgba(233, 193, 118, 0.4)",
                }}
              ></div>
              <div
                style={{
